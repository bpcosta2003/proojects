...
def frases():
  ...
  if var != "Estou digitando no teclado.":
    y = input("Você digitou a frase de maneira incorreta, tente novamente, digite [v] para voltar: ")
    if y == "v":
      frases()
    else:
      print("Comando inválido")
...
def estp():
  j = input("Está pronto para bater seu record? digite [y] para sim e [n] para não: ")
  if j == "y":
    pass
  elif j == "n":
    exit()
...
def end_star():
  ...
  print("\nDados:\n")
  print ("Você digitou em",tempo, "segundos na primeira e", tempo1, "segundos na segunda.")
  if possalt == "1":
  ...
  if tempo == tempo1:
    ...
    print("Você não bateu seu record, você fez em",round(tempo1 - tempo,1),"segundos mais devagar.")
  else:
    print("UAU! Você bateu seu record, você fez em",round(tempo - tempo1,1),"segundos mais rápido.")
